setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/GrunHSC")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/GrunHSC/GrunHSC_data.rds')
